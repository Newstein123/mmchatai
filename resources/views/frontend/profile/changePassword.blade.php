                ...
                <div class="card-body ">
                    ...
                    <form method="post" action="{{ route('ProfilePasswordChange') }}" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input  type="password" class="form-control @error('oldpassword')is-invalid @enderror"  name="oldpassword" placeholder="Old Password...">
                                @error('oldpassword')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input  type="password" class="form-control @error('oldpassword')is-invalid @enderror"  name="newpassword" placeholder="New Password...">
                                @error('newpassword')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input  type="password" class="form-control @error('oldpassword')is-invalid @enderror"  name="confirmpassword" placeholder="Confirm Password...">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                    ...
                                    <a href="{{ route('profilePage') }}" class="btn bg-custom">Back Profile</a>
                            </div>
                        </div>
                    </form>
                </div>
