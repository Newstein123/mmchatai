            ...
            <div class="row">             
					<div class="col-6 col-md-4">
						...
						<ul id="ServicesMenuList">
							<li><a href="/web-development.php" class="text-mute">Website Development</a></li>
							<li><a href="/software-development.php">Software Development</a></li>
							<li><a href="/e-commerce-solution.php">E-Commerce Solutions</a></li>
							<li><a href="/cctv-access-control.php">CCTV and Access Control</a></li>
							<li><a href="/server-networking.php">Server and Networking</a></li>
					...
					<div class="col-6 col-md-4">
						...
						<ul id="SupportMenuList">
							...
							<li><a href="/announcements">News and Announcements</a></li>
					...
					<div class="col-12 col-md-4 hidden-sm hidden-xs social">
						...
						<p class="bigger-130"><i class="far fa-envelope"></i> <a href="">info@myanmarictsolutions.pro</a></p>
